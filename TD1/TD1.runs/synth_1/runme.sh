...
HD_PWD='/home/dhahak/Bureau/VHDL/TD1/TD1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Test_Compteur16Bits.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Test_Compteur16Bits.tcl
