...
set rt::rc [catch {
  uplevel #0 {
    ...
    set ::env(RT_TMP) "./.Xil/Vivado-6889-insa-11292/realtime/tmp"
    ...
    if {$rt::useElabCache == false} {
      rt::read_vhdl -lib xil_defaultlib /home/dhahak/Bureau/VHDL/compteur.vhdl
      rt::filesetChecksum
    }
    rt::set_parameter usePostFindUniquification false
    set rt::top Test_Compteur16Bits
...
# MODE: 
    ...
    rt::set_parameter enableSplitFlowPath "./.Xil/Vivado-6889-insa-11292/"
